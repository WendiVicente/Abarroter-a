...
namespace POS.Forms
{
    public partial class Pago : BaseContext
    {
        ...
        {
            var montoTotalaPagar = decimal.Parse(txtmonto.Text);
            ...
            try
            {
                ...
                if (comboxpagos.SelectedIndex != 4)
                {
                    ...
                    {
                        if (comboxpagos.SelectedIndex == 0) { detalleCaja.Efectivo = decimal.Parse(txtmonto.Text); }
                        if (comboxpagos.SelectedIndex == 1) { detalleCaja.Cheques = decimal.Parse(txtmonto.Text); }
                        if (comboxpagos.SelectedIndex == 2) { detalleCaja.TarjetaCredito = decimal.Parse(txtmonto.Text); }
                        if (comboxpagos.SelectedIndex == 3) { detalleCaja.TarjetaDebito = decimal.Parse(txtmonto.Text); }
                        if (comboxpagos.SelectedIndex == 5) { detalleCaja.Transferencia = decimal.Parse(txtmonto.Text); }
                    }
        ...
        private void btnbuscarnitSAT_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (conectado)
                {
                    if (TokenObtenidoSat.Token != null)
                    {
