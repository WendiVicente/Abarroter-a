        ...
        public IList<ListarDetalleFacturas> GetDetallebyFactura(Guid idfact)
        {
            ...
            return ventas
               ...
               .Select(x => new ListarDetalleFacturas
               {
                   ...
                   EstiloId = x.DetalleEstiloId == null ? 0 : (int)x.DetalleEstiloId, 
                   DetalleRecargaId = x.DetalleRecargaId == null ? 0 : (int)x.DetalleRecargaId,
                   EsGrano = x.EsGrano == null ? false : (bool)x.EsGrano, 
               })
               .ToList();
        }
