   ...
   public class ProductosReserva
    {
        ...
        public int? DetalleEstiloId { get; set; }//null
        public int? DetalleGranoId { get; set; }//null
        ...
        public DetalleEstilo DetalleEstilo { get; set; }
        public DetalleGrano DetalleGrano { get; set; }
