...
namespace sharedDatabase.Models
{
    public class Producto
    {
        public Producto()
        {
            ...
            DetalleEstilos = new List<DetalleEstilo>();
        ...
        public decimal StockGrano { get; set; }
        ...
        public bool TieneEstilo { get; set; }
        ...
        public ICollection<DetalleEstilo> DetalleEstilos { get; set; }
